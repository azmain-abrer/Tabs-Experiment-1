import svgPaths from "./svg-w4emp5r8as";
...
import DraggableAddressBar from "../components/DraggableAddressBar";
...
function TabActions() {
  return (
    <div className="absolute box-border content-stretch flex h-[58px] items-center justify-between left-0 px-[40px] py-0 right-0 top-[93px]" data-name="Tab-Actions">
      <ActionsHome />
      <ActionsSwitcher />
      <ButtonsSparoOn />
      <ActionsComments />
...
function TabIcon({ canvasType }: { canvasType?: CanvasType | null }) {
  return (
    <div className="h-[18px] relative shrink-0 w-[16px]" data-name="Tab-Icon">
      <CanvasIcon canvasType={canvasType} />
    </div>
  );
}

function TabName({ tabName }: { tabName: string }) {
  return (
    <div className="box-border content-stretch flex items-center pb-px pt-0 px-0 relative shrink-0" data-name="Tab-Name">
      <p className="capitalize font-['Outfit:Regular',_sans-serif] font-normal leading-[normal] max-w-[188px] overflow-ellipsis overflow-hidden relative shrink-0 text-[16px] text-center text-neutral-950 text-nowrap whitespace-pre">{tabName}</p>
    </div>
  );
}

function ActionsRenameTab({ tabName, canvasType }: { tabName: string; canvasType?: CanvasType | null }) {
  return (
...
function ActiveTab({ 
  ...
  return (
    ...
    >
      <div className="bg-white h-full rounded-[100px]" data-name="Active-Tab">
        <div className="overflow-clip relative rounded-[inherit] size-full">
          <ActionsUndo />
          <ActionsRenameTab tabName={tabName} canvasType={canvasType} />
          <ActionsEditHistory />
        </div>
...
export default function MTabBar({ 
  ...
  return (
    <div className="backdrop-blur-[5px] backdrop-filter bg-[rgba(255,255,255,0.8)] relative size-full" data-name="M/Tab-Bar">
