import svgPaths from "./svg-52gs2ctpyt";
...
function TabName({ tabName }: { tabName: string }) {
  return (
    <div className="box-border content-stretch flex items-center pb-px pt-0 px-0 relative shrink-0" data-name="Tab-Name">
      <p className="capitalize font-['Outfit:Regular',_sans-serif] font-normal leading-[normal] max-w-[88px] overflow-ellipsis overflow-hidden relative shrink-0 text-[16px] text-center text-neutral-950 text-nowrap whitespace-pre">{tabName}</p>
    </div>
  );
}
